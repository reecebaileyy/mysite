    ...
    <>
      <div>
        ...
        <div className={`${divClass3} flex flex-col items-center justify-center`}>
          ...
          {/* ABOUT */}
          <div id='about' className='pb-20 md:mt-0 mt-10 mb-36 w-1/2 md:3/4 lg:w-3/4 xl:w-3/4 2xl:w-3/4 grid grid-cols-2 gap-4 sm:flex md:flex sm:flex-col md:flex-col sm:w-full  md:w-full'>
          ...
          {/* PROJECTS */}
          <div id='about' className='sm:px-10 md:px-10 pb-20 md:mt-0 mt-10 mb-36 w-1/2 lg:w-3/4 xl:w-3/4 2xl:w-3/4 grid grid-cols-8 grid-flow-col place-content-center auto-cols-min gap-4 sm:w-full md:w-full'>
