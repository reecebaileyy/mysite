    ...
    <>
      <div>
        ...
        <div className={`${divClass3} flex flex-col items-center justify-center`}>
          ...
          {/* PROJECTS */}
          <div id='about' className='sm:px-10 md:px-10 pb-20 md:mt-0 mt-10 w-1/2 lg:w-3/4 xl:w-3/4 2xl:w-3/4 grid grid-cols-8 grid-flow-col place-content-center auto-cols-min gap-4 sm:w-full md:w-full'>
