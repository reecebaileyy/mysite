      ...
      <div>
        ...
        <div className={`${divClass3} flex flex-col items-center justify-center`}>
          ...
          <div id='about' className='md:mt-0 sm:mb-64 mt-24 w-1/2 lg:w-3/4 xl:w-3/4 2xl:w-3/4 grid grid-cols-2 gap-4 sm:flex md:flex sm:flex-col md:flex-col sm:w-full  md:w-full'>
            <div className='sm:w-full sm:px-10 md:px-10 font-roboto text-light-gray text-3xl sm:text-base'>
              ...
              <h1 className='font-roboto font-light text-sm sm:text-xs lg:text-xs md:text-xs text-slate'>
                Hello! My name is Reece, I&apos;m an aspiring software engineer passionate about solving complex problems. My software development journey took off in 2021 when I decided to begin creating ethereum smart contracts and ethereum decentralized applications — turns out hacking together an NFT project taught me a lot about object oriented programming. <br /><br /> Fast forward to today, I&apos;ve had the privilege of competing in <span class="text-bright-green">multiple hackathons</span> and co-hosting a Base hackathon at my university — experiences that sharpened my abilities in <span class="text-bright-green">rapid prototyping, teamwork, and execution under pressure</span>.
          ...
          <div id="contact" className='flex flex-col items-center justify-center w-1/2 lg:w-3/4 xl:w-3/4 2xl:w-3/4 mt-36 sm:mt-0 md:mt-0 sm:py-20 md:py-20'>
            <p className='font-roboto text-bright-green text-center text-sm sm:text-xs'>03. Contact Me</p>
