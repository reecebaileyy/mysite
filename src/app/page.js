      ...
      <div className="min-h-screen bg-dark-blue">
        <nav className="font-roboto font-light pt-10 px-5 md:px-10 flex justify-between items-center relative">
          ...
          <div className="xl:hidden 2xl:hidden 3xl:hidden">
            ...
            <div className={`fixed top-0 right-0 bottom-0 w-1/2 bg-dark-blue overflow-auto transform ${isOpen ? 'translate-x-0' : 'translate-x-full'} transition-transform duration-200 ease-in-out`}
              onClick={(e) => {
          ...
          <div className='flex gap-2 items-center sm:hidden lg:hidden md:hidden'>
            <ul className='flex md:hidden sm:hidden lg:hidden space-x-12 md:space-x-12 text-xl md:text-2xl'>
              <li><Link className='text-xs text-light-gray hover:text-bright-green' href="#About"><span className='text-bright-green'>01.</span> About</Link></li>
              <li><Link className='text-xs text-light-gray hover:text-bright-green' href="#Projects"><span className='text-bright-green'>02.</span> Projects</Link></li>
              <li><Link className='text-xs text-light-gray hover:text-bright-green' href="#Contact"><span className='text-bright-green'>03.</span> Contact</Link></li>
              <li><Link className='text-xs text-bright-green border-2 p-3 rounded-md border-solid border-bright-green' href="#Contact">Resume</Link></li>
            </ul>
          </div>
        </nav>
